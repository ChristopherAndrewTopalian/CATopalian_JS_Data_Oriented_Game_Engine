# CATopalian JS Data Oriented Game Engine
This DOD DOM based JS game engine is designed for efficiency! This game engine easily SAVES and LOADS world data in the json format!
